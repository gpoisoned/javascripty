...
class ArithmeticSpec extends FlatSpec {
  ...
  "Plus" should "add a number and string" in {
    val e1 = N(1)
    val e2 = S("2")
  ...
  "Plus" should "add two strings" in {
    val e1 = S("xyz")
    val e2 = S("abc")
    val e3 = eval(Binary(Plus, e1, e2))
    assert(e3 === S("xyzabc"))
  ...
  "Plus" should "add boolean and a number" in {
    val e1 = B(true)
    val e2 = N(5)
    val e3 = eval(Binary(Plus, e1, e2))
    assert(e3 === N(6))
  }
    "Plus" should "add two booleans" in {
    val e1 = B(false)
    val e2 = B(false)
    val e3 = eval(Binary(Plus, e1, e2))
    assert(e3 === N(0))
   ...
   "Plus" should "add boolean and string" in {
    val e1 = B(false)
    val e2 = S("whatever")
    val e3 = eval(Binary(Plus, e1, e2))
    assert(e3 === S("falsewhatever"))
    }
  ...
  "Minus" should "subtract number and a boolean" in {
    val e1 = N(3)
    val e2 = B(false)
    val e3 = eval(Binary(Minus, e1, e2))
    assert(e3 === e1)
   ...
   "Minus" should "subtract a number and NaN" in {
    val e1 = N(3)
    val e2 = N(Double.NaN)
    val e3 = eval(Binary(Minus, e1, e2))
    assert(eval(Binary(Eq,e3,e2)) == B(false))
  }
  ...
  "Times" should "multiply two number values and return a number" in {
   ...
   "Times" should "multiply two NaNs" in {
    val e1 = N(Double.NaN)
    val e2 = N(Double.NaN)
    val e3 = eval(Binary(Times, e1, e2))
    assert(eval(Binary(Eq,e3,e1)) == B(false))
  }

     
  "Times" should "multiply a string and a NaN" in {
    val e1 = N(Double.NaN)
    val e2 = S("xyz")
    val e3 = eval(Binary(Times, e1, e2))
    assert(eval(Binary(Eq,e3,e1)) == B(false))
